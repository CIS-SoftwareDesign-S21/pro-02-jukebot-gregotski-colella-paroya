...
class ServerCommands(commands.Cog):
    ...
    @commands.command(name='connect', help='Connects to voice channel')
    async def connect(ctx, msg):
        if msg.author.voice:
    ...
    @commands.command(name='disconnect', help='Disconnects from voice channel')
